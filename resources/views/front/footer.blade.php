                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="widget widget-contact text-center">
                                <h2><span>Contactez-nous</span> Pour commander </h2>
                                <p>Ne soyez pas timide, nous ne mordons pas :)</p>
                                <strong>+216 54312703</strong>
            ...
            <div class="bottom-footer">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="copyright">
                                <p>© All Rights Reserved. Zarzis Delivery 2021</p>
                            </div><!--copyright end-->
                        </div>
                        <div class="col-lg-6">
