  ...
  <div class="auth-inner py-2">
    ...
    <div class="card mb-0">
      <div class="card-body">
        ...
        <h4 class="card-title mb-1">Devient un livreur🚀</h4>
        <p class="card-text mb-2">Devenir un Livreur avec Zarzis Delivry</p>
        ...
        <form class="auth-register-form mt-2" method="POST" action="{{ route('registerLivreur') }}">
          ...
          <button type="submit" class="btn btn-primary btn-block" tabindex="5">Inscription</button>
        </form>
