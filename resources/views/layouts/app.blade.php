...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('back/css/plugins/forms/form-validation.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('back/css/pages/page-auth.css')}}">
    <!-- END: Page CSS-->
...
.bg-primary{
  ...
  <div id="app">
    ...
    <script src="{{asset('back/vendors/js/forms/validation/jquery.validate.min.js')}}"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{asset('back/js/scripts/pages/page-auth-login.js')}}"></script>
    <!-- END: Page JS-->
